...
<thead>
    <tr>
        ...
        <th style="vertical-align: middle;" class="text-center" width="25%">FOTO</th>
...
<tbody>
  ...
  <tr>
    ...
    <td>
    <?php if($staff->gambar!="") { ?>
      <img src="<?php echo base_url('assets/upload/staff/'.$staff->gambar) ?>" class="img img-thumbnail img-responsive" width="60">
      <?php }else{ ?>
      <img src="<?php echo base_url('assets/upload/staff/thumbs/'.$site->icon) ?>" class="img img-thumbnail img-responsive" width="60">
      <?php } ?>
    </td>
    <td><?php echo $staff->nama ?><br>
    <small>NIP: <?php echo $staff->nip ?><br>
    ...
    <td>
      ...
      <div class="btn-group">
        ...
        <?php if($staff->jabatan!=="Kepala Dinas" && $staff->jabatan!=="Sekretaris Dinas" ) { ?>
