...
<script>
 CKEDITOR.replace( 'isi', {
  height: 300,
  filebrowserBrowseUrl: '<?php echo base_url('/admin/berita/uploadfile') ?>',
    filebrowserImageBrowseUrl: '<?php echo base_url() ?>assets/upload/image',
    filebrowserUploadUrl: '<?php echo base_url('/admin/berita/uploadfile') ?>',
    filebrowserImageUploadUrl: '<?php echo base_url('/admin/berita/uploadfile') ?>',
 });
</script>
<!-- Page Script -->
