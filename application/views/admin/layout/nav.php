        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="<?php echo base_url('admin/berita/tambah2') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Berita &amp;  Portal</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/berita/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Berita Pribadi </p></a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/berita/daerah/') ?><?php echo $this->session->userdata('id_user'); ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Data Berita &amp; Profil</p></a>
              </li>
          ...
          <?php if($this->session->userdata('akses_level')=="Admin"|| $this->session->userdata('akses_level')=='User'|| $this->session->userdata('akses_level')=='PKP') { ?>
           <!-- <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>IPKD <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/ipkd') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Data IPKD</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/ipkd/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah IPKD</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/kategori_ipkd') ?>" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Kategori IPKD</p></a>
              </li>
            </ul>
          </li>  -->
          <?php } ?>
