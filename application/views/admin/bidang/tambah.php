...
// Form buka 
echo form_open(base_url('admin/bidang'));
?>

<div class="form-group">
<input type="text" name="nama_bidang" class="form-control" placeholder="Nama kategori" value="<?php echo set_value('nama_bidang') ?>" required>
</div>
<div class="form-group">
<label>Isi</label>
