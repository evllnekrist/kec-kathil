	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<select name="akses_level" class="form-control">
				...
				<option value="Bidang" <?php if($user->akses_level=="Bidang") { echo "selected"; } ?>>Bidang</option>
				<option value="PKP" <?php if($user->akses_level=="PKP") { echo "selected"; } ?>>PKP</option>
...
<div class="form-group">
<label>Bagian Berita</label>
<select name="id_kategori" class="form-control">

	<?php foreach($kategori as $kategori) { ?>
	<option value="<?php echo $kategori->id_kategori ?>"  <?php if($user->id_kategori==$kategori->id_kategori) { echo "selected"; } ?>>
