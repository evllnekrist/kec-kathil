                            ...
                            <div class="col-md-8">
                                ...
                                <div class="blog-items">
                                    <div class="blog-img" style="width:770px;height:370px;">
                                        <a href="<?php echo base_url('berita/read/' . $row['slug_berita']);?>"><img src="<?php echo base_url('assets/upload/image/'.$row['gambar']);?>" alt="blog-img-10" class="img-responsive" /></a>
                                    </div>
                                    <!-- .blog-img -->
                                    <div class="blog-content-box">
                                        <div class="blog-content">
                                            <h4><a href="<?php echo base_url('berita/read/' . $row['slug_berita']);?>"><?php echo $row['judul_berita'];?></a></h4>
                                            <ul class="meta-post">
                                                <li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date('d M Y', strtotime($row['tanggal_publish']));?></li>
                                                <!--<li><i class="fa fa-user"></i> <?php echo $row['nama'];?></li>-->
                                                 <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $row['hits'];?> Viewer</a></li> 
                                            </ul>
                                            <p class="text-justify"><?php echo character_limiter(strip_tags($row['isi']), 200); ?></p>
                                            <a href="<?php echo base_url('berita/read/' . $row['slug_berita']);?>"><i class="fa fa-chevron-right"></i> Selengkapnya</a>
                                        </div>
                                        <!-- .blog-content -->
                                    </div>
                                    <!-- .blog-content-box -->
