                                                ...
                                                <?php foreach($populer as $populer) { ?>
                                                    <li>
                                                        <div class="popular-news-img" style="width: 80px; height: 80px;">
                                                            <a href="#"><img src="<?php if($populer->gambar=="") { echo base_url('assets/upload/image/'.$site->icon); }else{ echo base_url('assets/upload/image/'.$populer->gambar); } ?>" alt="Foto-berita" /></a>
                                                        </div>
                                                        <!-- .popular-news-img -->
