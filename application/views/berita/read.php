...
<link rel="shortcut icon" href="<?php echo base_url('assets/upload/image/'.$berita->gambar) ?>"> 
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="blog-items">
                            <?php if($berita->gambar !="") { ?>
                                ...
                                <center><figure>
                                <figcaption style="background-color: #000000bd;color: white;"><?php echo $berita->caption; ?></figcaption>
                                </figure></center>
                            <?php } ?>
                            <!-- .blog-img -->
                                ...
                                <div class="meta-box">
                                    <div class="event-author-option">
                                        <div class="event-author-name">
                                            <p>Posted by : <a href="#"> <?php echo $berita->nama_user; ?></a></p>
                                        </div>
                                        <!-- .author-name -->
                                    </div>
                                    <!-- .author-option -->
                                        ...
                                        <?php foreach($listing as $listing) { ?>
                                            <li>
                                                <div class="popular-news-img" style="width: 80px; height: 80px;">
                                                    <a href="#"><img src="<?php if($listing->gambar=="") { echo base_url('assets/upload/image/'.$site->icon); }else{ echo base_url('assets/upload/image/'.$listing->gambar); } ?>" alt="Bertia-Lainnya" /></a>
                                                </div>
                                                <!-- .popular-news-img -->
